...
const db = {
  ...
  categories: [
    ...
    },
    {
      ...
      isObligation: true,
      questions: [
        "Si impegna a fare un massaggio rilassante di almeno 15 minuti",
        "Si impegna a preparare la mia cena preferita questa settimana",
        "Si impegna a fare con me quell'attività che si è sempre rifiutatə di provare",
        "Si impegna a regalarmi un momento di coccole senza telefono per almeno 30 minuti",
        "Si impegna a organizzare per me una serata romantica a sorpresa",
        "Si impegna a preparare un bagno caldo con candele e massaggio",
        "Si impegna a essere il/la mio/a schiavə personale per un'ora",
        "Si impegna a ballare per me la sua canzone più sexy",
        "Si impegna a portarmi a cena nel mio ristorante preferito",
        "Si impegna a fare il/la camerierə personale per una serata intera",
        "Si impegna a realizzare una mia fantasia erotica",
        "Si impegna a farmi un servizio fotografico sexy solo per me",
        "Si impegna a lasciarsi bendare e farmi fare quello che voglio per 10 minuti",
        "Si impegna a darmi il controllo completo su di sé per 20 minuti",
        "Si impegna a fare uno strip-tease per me con la canzone che scelgo",
        "Si impegna a farmi un massaggio erotico con oli essenziali",
        "Si impegna a essere il mio cuscino umano per un intero film",
        "Si impegna a portarmi la colazione a letto nel weekend",
        "Si impegna a farmi 3 complimenti sinceri ogni giorno per una settimana",
        "Si impegna a comprare e indossare quello che scelgo",
      ],
      instructions: `
