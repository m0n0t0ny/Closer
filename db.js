...
const db = {
  ...
  categories: [
    ...
    },
    {
      ...
      isObligation: true,
      questions: [
        "Fammi un massaggio rilassante di almeno 15 minuti",
        "Prepara la mia cena preferita questa settimana",
        "Fai con me quell'attività che ti sei sempre rifiutatə di provare",
        "Regalami un momento di coccole senza telefono per almeno 30 minuti",
        "Organizza per me una serata romantica a sorpresa",
        "Preparami un bagno caldo con candele e massaggio",
        "Sii il mio/la mia schiavə personale per un'ora",
        "Balla per me la tua canzone più sexy",
        "Portami a cena nel mio ristorante preferito",
        "Fai il/la camerierə personale per una serata intera",
        "Realizza una mia fantasia erotica",
        "Fammi un servizio fotografico sexy solo per me",
        "Lasciati bendare e fammi fare quello che voglio per 10 minuti",
        "Dammi il controllo completo su di te per 20 minuti",
        "Fai uno strip-tease per me con la canzone che scelgo",
        "Fammi un massaggio erotico con oli essenziali",
        "Sii il mio cuscino umano per un intero film",
        "Portami la colazione a letto nel weekend",
        "Fammi 3 complimenti sinceri ogni giorno per una settimana",
        "Compra e indossa per me quello che scelgo",
      ],
      instructions: `
